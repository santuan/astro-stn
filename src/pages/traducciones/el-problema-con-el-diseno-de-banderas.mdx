...
export const components = { Youtube, ImageCaption };
...
<Youtube videoId="pnv5iKB2hl4" title="El problema con las banderas de las ciudades" />

<ImageCaption>Se recomienda ver la experiencia completa en video.</ImageCaption>
