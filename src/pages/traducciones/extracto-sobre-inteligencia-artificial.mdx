...
Extraído del podcast de Lex Friedman con David Silver. Uno de los desarrolladores del sistema que le gano al campeón mundial Lee Sedol en el juego <small>GO</small> con un resultado de 4 a 1.
